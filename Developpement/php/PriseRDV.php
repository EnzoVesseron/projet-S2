...
// Création d'une nouvelle instance de webpage nommée priseRDV
$priseRDV = new WebPage();

// Titre de la page priseRDV
$priseRDV->setTitle("Prise de rendez-vous");

// Url bootstrap à mettre
$priseRDV->appendCssUrl("");

// Css de la page à mettre
$priseRDV->appendCss(<<<CSS

CSS
);

// Ajout de l'entête de la page en HTML
$priseRDV->appendToHead(<<<HTML

HTML
);

// Commencement boucle pour afficher des choses de la base de données
$priseRDV->appendContent(<<<HTML
