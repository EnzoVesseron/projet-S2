...
<body class="bg-light">
    ...
    <h2>Quels usages en avez vous ?</h2>
    <p id="desc">Sélectionnez l'usage que vous souhaitez peivilégier pour votre nouveau pc</p>

    <div class="row row-cols-1 row-cols-md-3 g-4 " id="card">
        <div class="col">
          <div class="card h-100 text-center">
            <img src="../assets/img/code.jpg" class="card-img-top card-img-top-custom2" alt="...">
            <div class="card-body ">
              <h5 class="card-title">Devellopement</h5>
              <a href="Quizz3.php?budget={$_GET["budget"]}&utilisation=dev"
        ...
        <div class="col">
          <div class="card h-100 text-center">
            <img src="../assets/img/editing.jpg" class="card-img-top card-img-top-custom2" alt="...">
            <div class="card-body">
              <h5 class="card-title">Montage</h5>
              <a href="Quizz3.php?budget={$_GET["budget"]}&utilisation=mont"
              class=" gradient-button py-1 rounded-3 fw-bold shadow nav-link text-white m-3 text-center"
              style="width: 110px;">Choisir</a>
            </div>
          </div>
        ...
        <div class="col ">
          <div class="card h-100 text-center">
            <img src="../assets/img/gaming.jpg" class="card-img-top card-img-top-custom2" alt="...">
            <div class="card-body justify-content-center">
              <h5 class="card-title">Jeux vidéo</h5>
              <a href="Quizz3.php?budget={$_GET["budget"]}&utilisation=games"
              class=" gradient-button py-1 rounded-3 fw-bold shadow nav-link text-white m-3 text-center"
              style="width: 110px;">Choisir</a>
            </div>
          </div>
        ...
        <div class="button d-flex m-3 justify-content-center">
            <a href="Quizz1.php" class="bg-white py-1 rounded-3 fw-bold shadow nav-link text-dark m-3 text-center"
