...
<body class="bg-light">
    ...
    <p id="desc">Cliquez sur le bouton continuer pour afficher les configs recommendées</p>

    <img src="../assets/img/réussi.png" id="imgresult" class="mx-auto d-block">
        <div class="button d-flex m-3 justify-content-center">
            <a href="#"
                ...
                style="width: 100px;">Continuer</a>
            <a href="Quizz3.php?budget={$_GET["budget"]}&utilisation={$_GET["utilisation"]}" class="bg-white py-1 rounded-3 fw-bold shadow nav-link text-dark m-3 text-center"
